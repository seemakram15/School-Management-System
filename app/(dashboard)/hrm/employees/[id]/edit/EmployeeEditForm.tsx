...
export default function EmployeeEditForm({ employee }: { employee: Employee }) {
  ...
  const [form, setForm] = useState({
    ...
    extra_activity: employee.extra_activity ?? "",
    note: employee.note ?? "",
    sms_receive_no: String(employee.sms_receive_no ?? "0"),
    father_name: employee.father_name ?? "",
    father_phone_no: employee.father_phone_no ?? "",
    mother_name: employee.mother_name ?? "",
    mother_phone_no: employee.mother_phone_no ?? "",
    guardian: employee.guardian ?? "",
    guardian_phone_no: employee.guardian_phone_no ?? "",
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Edit Employee</p>
        </div>
